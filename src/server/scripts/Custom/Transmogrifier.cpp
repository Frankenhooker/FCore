...
public:
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
        ...
        if (sT->GetEnableTransmogInfo())
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, "|TInterface/ICONS/INV_Misc_Book_11:30:30:-18:0|tItem, which you want to transmog on the item has to be in the bag. Attention, legendaries don't work.", EQUIPMENT_SLOT_END+9, 0);
